...
import * as Api from './Api'; // ← add this (adjust path as needed)
        ...
        const fetchData = async () => {
            try {
                ...
                switch (dataType) {
                    case 'projects':
                        result = category
                            ? await Api.getProjectByCategory(category)
                            : await Api.getAllProjects();
                        break;
                    case 'skills':
                        result = category
                            ? await Api.getSkillsByCategory(category)
                            : await Api.getAllSkills();
                        break;
                    case 'experiences':
                    ...
                    case 'aboutMe':
                        ...
                        break;
                    case 'messages':
                        result = await Api.getAllMessages();
                        break;
                    default:
